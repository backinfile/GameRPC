...
public abstract class AbstractRPCServerService extends Port {
    public static final String PORT_ID_PREFIX = "RPCServerService";
    ...
    public AbstractRPCServerService() {
        super(PORT_ID_PREFIX);
    }

    public AbstractRPCServerService(String serviceId) {
        super(serviceId);
    }
